...
const SignUp = () => {
  const { data } = useSWR('http://ec2-3-38-35-210.ap-northeast-2.compute.amazonaws.com:8080/api/v1/user/me', fetcher);
  ...
  const onSubmit = useCallback(
    (e) => {
      ...
      if (!mismatchError) {
        ...
        axios
          .post('http://ec2-3-38-35-210.ap-northeast-2.compute.amazonaws.com:8080/api/v1/signup', {
            username,
            email,
            password,
          })

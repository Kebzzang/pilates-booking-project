...
public class CorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        List<String> allowOrigins = Arrays.asList("http://3.38.35.210:80/**","http://3.38.35.210:80","http://3.38.35.210/**","http://3.38.35.210","http://localhost:80/**", "http://localhost:80","http://localhost:3000", "http://localhost:3000/**");
